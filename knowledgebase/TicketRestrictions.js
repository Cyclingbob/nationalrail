...
// 2nd October 2021
// This code generates a token to access the National Rail Open Data API (https://opendata.nationalrail.co.uk/) and then uses this to get the current Ticket Restrictions right now. I've written the code so only the first ticket restriction is logged to the console, but all are available. The result is a JavaScript Object.
